...
class AvailabilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post availabilities_url, params: { availability: { appointment_id: @availability.appointment_id, end_time: @availability.end_time, start_time: @availability.start_time, user_id: @availability.user_id } }
    end
  ...
  test "should update availability" do
    patch availability_url(@availability), params: { availability: { appointment_id: @availability.appointment_id, end_time: @availability.end_time, start_time: @availability.start_time, user_id: @availability.user_id } }
